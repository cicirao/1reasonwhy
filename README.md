...
<strong>25 top tweets:</strong> include top 25 tweets objects.     
<strong>Authors:</strong> include a list of author objects who created the top 25 retweeted tweets.    
